...
requirements = python3==3.11.*,hostpython3==3.11.*,kivy,fastapi,uvicorn,anthropic,bilibili-api-python,aiohttp,python-dotenv,toml,pydantic,starlette,anyio,httptools
